        ...
        public void AgregarPadre(Padres padre)
        {
            try
            {
                ...
                */
                ...
                {
                    connection.Open();
                    SqlCommand command = new SqlCommand("INSERT INTO padres (numero_documento, nombre_completo, direccion, telefono) VALUES (@numeroDocumento, @nombre, @direccion, @telefono)", connection);
