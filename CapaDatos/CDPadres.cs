        ...
        public void AgregarPadre(Padres padre)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    SqlCommand command = new SqlCommand("INSERT INTO padres ( numero_documento, nombre_completo, direccion, telefono) VALUES (@tipoDocumento, @numeroDocumento, @nombre, @direccion, @telefono)", connection);
